...
Clone the repo http://bit.ly/adv-faas-tutorial[Advanced FaaS Tutorial], we call this folder as `$PROJECT_HOME`.  Navigate to `integration/messaging-functions` folder.
